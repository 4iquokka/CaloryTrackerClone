package ca.enzeroment.clone.calorytracker.core.data.preferences

import android.content.SharedPreferences
import ca.enzeroment.clone.calorytracker.core.domain.model.ActivityLevel
...
import ca.enzeroment.clone.calorytracker.core.domain.model.UserInfo
...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        return UserInfo(
            ...
            gender = Gender.fromString(sharedPref.getString(Preferences.KEY_GENDER, null)),
            activityLevel = ActivityLevel.fromString(sharedPref.getString(Preferences.KEY_ACTIVITY_LEVEL, null)),
            goalType = GoalType.fromString(sharedPref.getString(Preferences.KEY_GOAL_TYPE, null)),
