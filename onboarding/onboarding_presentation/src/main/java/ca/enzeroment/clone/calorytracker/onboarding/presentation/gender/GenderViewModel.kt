...
constructor(
    ...
    private val _uiEvent = Channel<UiEvent>() //UI only receive via channel  only observe changes not send somthing
    val uiEvent= _uiEvent.receiveAsFlow() // doing only once
